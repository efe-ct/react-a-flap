...
// Bird component to represent a bird in the game
    ...
    return (
        ...
        >
            <div className="w-full h-full bg-gradient-to-br from-yellow-400 via-orange-400 to-red-500 rounded-full shadow-lg border-2 border-white relative overflow-hidden">
                ...
                {/* <div
                    className="absolute left-1/2 top-1/4 w-1/5 h-1/5 bg-orange-500 rounded-full transform -translate-x-1/2"
                    style={{
            ...
            {/* Wing */}
            <div className="absolute top-3 left-1 w-4 h-3 b-gradient-to-r from-orange-500 to-red-500 rounded-full opacity-80"></div>
            <div></div>
        </div>
